...
let s:colors = {
      ...
      \ "red": get(s:overrides, "red", { "gui": "#E5C07B", "cterm": "180", "cterm16": "3" }),
      ...
      \ "black": get(s:overrides, "black", { "gui": "#24273A", "cterm": "235", "cterm16": "0" }),
      \ "foreground": get(s:overrides, "foreground", { "gui": "#ABB2BF", "cterm": "145", "cterm16": "NONE" }),
      \ "background": get(s:overrides, "background", { "gui": "#24273A", "cterm": "235", "cterm16": "NONE" }),
      ...
      \ "cursor_grey": get(s:overrides, "cursor_grey", { "gui": "#24273A", "cterm": "236", "cterm16": "0" }),
      \ "visual_grey": get(s:overrides, "visual_grey", { "gui": "#3E4452", "cterm": "237", "cterm16": "8" }),
      \ "menu_grey": get(s:overrides, "menu_grey", { "gui": "#24273A", "cterm": "237", "cterm16": "7" }),
      \ "special_grey": get(s:overrides, "special_grey", { "gui": "#24273A", "cterm": "238", "cterm16": "7" }),
