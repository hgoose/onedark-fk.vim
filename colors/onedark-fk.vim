...
" Vim Color File
" Name:       onedark_fk.vim
" Maintainer: https://github.com/joshdick/onedark_fk.vim/
" License:    The MIT License (MIT)
" Based On:   https://github.com/MaxSt/FlatColor/

" Companion statusline plugin and terminal themes are included with onedark_fk.vim:
"  * https://github.com/joshdick/onedark_fk.vim#lightlinevim-colorscheme
"  * https://github.com/joshdick/onedark_fk.vim#vim-airline-theme
"  * https://github.com/joshdick/onedark_fk.vim/tree/main/term
...
let g:colors_name="onedark_fk"

" Set to "256" for 256-color terminals, or
" set to "16" to use your terminal emulator's native colors
" (a 16-color palette for this color scheme is available; see
" < https://github.com/joshdick/onedark_fk.vim/blob/main/README.md >
" for more information.)
if !exists("g:onedark_fk_termcolors")
  let g:onedark_fk_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:onedark_fk_terminal_italics")
  let g:onedark_fk_terminal_italics = 0
endif

" This function is based on one from FlatColor: https://github.com/MaxSt/FlatColor/
" Which in turn was based on one found in hemisu: https://github.com/noahfrederick/vim-hemisu/
let s:group_colors = {} " Cache of default highlight group settings, for later reference via `onedark_fk#extend_highlight`
function! s:h(group, style, ...)
  if (a:0 > 0) " Will be true if we got here from onedark_fk#extend_highlight
  ...
  if g:onedark_fk_terminal_italics == 0
...
function! onedark_fk#set_highlight(group, style)
  call s:h(a:group, a:style)
endfunction

function! onedark_fk#extend_highlight(group, style)
...
if get(g:, 'onedark_fk_hide_endofbuffer', 0)
...
" https://github.com/joshdick/onedark_fk.vim/issues/313
